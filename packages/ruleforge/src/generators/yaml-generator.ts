...
export class YAMLGenerator {
   ...
   * 生成规则描述
   */
  private generateRuleDescription(pattern: Pattern): string {
   ...
   * 生成规则模式
   */
  private generateRulePattern(pattern: Pattern): string | RegExp {
    switch (pattern.type) {
      case 'code-style':
   ...
   * 生成代码风格模式
   */
  private generateCodeStylePattern(pattern: Pattern): string | RegExp {
   ...
   * 生成架构模式
   */
  private generateArchitecturePattern(pattern: Pattern): string | RegExp {
   ...
   * 生成最佳实践模式
   */
  private generateBestPracticePattern(pattern: Pattern): string | RegExp {
   ...
   * 生成错误模式
   */
  private generateErrorPattern(pattern: Pattern): string | RegExp {
   ...
   * 生成规则替换
   */
  private generateRuleReplacement(pattern: Pattern): string | undefined {
   ...
   * 生成规则示例
   */
  private generateRuleExamples(pattern: Pattern): RuleExample[] {
   ...
   * 生成示例的 "before" 部分
   */
  private generateExampleBefore(example: any, pattern: Pattern): string {
    if (example.code) {
      return example.code;
    }
   ...
   * 生成示例的 "after" 部分
   */
  private generateExampleAfter(example: any, pattern: Pattern): string {
   ...
   * 生成默认示例
   */
  private generateDefaultExample(pattern: Pattern): RuleExample {
    return {
   ...
   * 生成规则标签
   */
  private generateRuleTags(pattern: Pattern): string[] {
