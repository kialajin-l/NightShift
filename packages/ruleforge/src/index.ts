...
export { ConversationLogParser }; export type { ConversationLog, ParseResult } from './parsers/conversation-log-parser';
export { PatternRecognitionEngine }; export type { Pattern } from './engines/pattern-recognition-engine';
export { YAMLGenerator }; export type { RuleYAML, ValidationResult } from './generators/yaml-generator';
export { RuleForgeCore, createRuleForge, defaultRuleForge }; export type { RuleForgeConfig, RuleForgeResult } from './ruleforge-core';
 ...
 * 初始化 RuleForge
 */
export function initializeRuleForge(config?: RuleForgeConfig): RuleForgeCore {
 ...
 * 快速处理会话日志
 */
export async function quickProcess(log: ConversationLog): Promise<RuleForgeResult> {
 ...
 * 验证规则 YAML
 */
export function validateRuleYAML(yamlString: string): ValidationResult {
